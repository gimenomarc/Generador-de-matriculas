      ...
      <CSSTransition in={true} appear={true} timeout={300} classNames="fade">
        <div className="flex justify-center items-center space-x-4">
          <h1 className="text-4xl mb-4 font-semibold">
            API Generador de Matrículas en progreso
          </h1>
      ...
      <CSSTransition in={true} appear={true} timeout={900} classNames="fade">
        <ul className="list-disc pl-5 mb-4 text-left inline-block">
          ...
          <li className="text-lg">
            ...
            España, us para Estados Unidos, aus para Australia, de para
            Alemania, fr para Francia, uk para Reino Unido e it para Italia.
          </li>
          <li className="text-lg">
            <strong>GET /comprobar-matricula/:pais/:matricula:</strong>{" "}
            Comprueba si una matrícula es válida para el país especificado. Los
            países soportados para esta funcionalidad son es para España, us
            para Estados Unidos, aus para Australia, de para Alemania, fr para
            Francia, uk para Reino Unido e it para Italia.
          </li>
          <li className="text-lg">
            <strong>GET /determinar-pais/:matricula:</strong> Determina a qué
            país pertenece una matrícula introducida.
          </li>
        </ul>
      </CSSTransition>
    </div>
