  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center mt-8">
        ...
        />
        <button
          className={`transition duration-300 ease-in-out transform hover:-translate-y-0.5 hover:scale-105 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 flex-grow ${
            darkMode ? "dark-mode" : ""
          }`}
        ...
        >
          <div
            className={`mt-10 w-full max-w-sm p-5 text-center rounded-xl text-white ${
